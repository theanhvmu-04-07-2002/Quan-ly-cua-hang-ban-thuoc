...
END
GO
INSERT INTO USER_USE (FULLNAME,USERNAME,PASSWORD,SEX,PERMISION) VALUES  (N'Nguyễn Thế Anh','admin','12345678',N'Nam',1)
GO
...
GO
SELECT MEDICINE_NAME as [Tên thuốc],SUM(NUMBER_MEDICINE) AS [Tổng Số lượng]
            FROM MEDICINE
