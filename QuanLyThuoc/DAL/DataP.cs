   ...
   public class DataP
    {
        ...
        public string connectSTR = @"Data Source=DESKTOP-T123VEQ\SQLEXPRESS;Initial Catalog=QLNT;Integrated Security=True";
        //Data Source=.;Initial Catalog=QLNT;Integrated Security=True
